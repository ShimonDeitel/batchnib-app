...
enum Theme {
    static let accent = Color(hex: "#5C3A21")
    static let accentSecondary = Color(hex: "#B08D57")
    static let background = Color(hex: "#F2ECE3")
    static let cardBackground = Color.white.opacity(0.7)
    static let textPrimary = Color(hex: "#5C3A21").opacity(0.95)
